        ...
        ScrollView {
            VStack(spacing: Spacing.m) {
                ...
                DisclosureSectionCard(
                    ...
                    content: "회원 탈퇴 시 또는 개인정보 수집 및 이용목적이 달성된 후에는 지체 없이 파기합니다. 단, 관계 법령에 의해 보존할 필요가 있는 경우 해당 기간 동안 보관됩니다."
                )
                ...
                DisclosureSectionCard(
                    ...
                    이를 위해서는 앱 내 '설정' 메뉴를 통해 직접 처리하거나 개인정보 보호책임자에게 이메일로 연락하시면 됩니다.
                    """
                )
                ...
                DisclosureSectionCard(
                    title: "7. 알림 서비스 관련 권한 사용",
                    content: """
                    MyiApp은 일정 알림 제공을 위해 기기의 알림 권한을 사용합니다.
                    알림 권한은 앱 설정에서 언제든지 변경할 수 있습니다.
                    """
                )

                DisclosureSectionCard(
                    title: "8. 오디오 분석 관련 권한 사용",
                    content: """
                    MyiApp은 아기 울음소리 분석을 위해 마이크 권한을 사용합니다.
                    수집된 오디오 데이터는 분석 목적으로만 사용되며, 사용자의 동의 없이 외부로 전송되지 않습니다.
                    분석은 기기 내에서 CoreML 모델을 통해 이루어집니다.
                    """
                )
                ...
                DisclosureSectionCard(
                    ...
                    content: "이 개인정보 처리방침은 법령, 정책 또는 보안 기술의 변경에 따라 내용이 추가, 삭제 및 수정될 수 있으며, 변경사항이 발생할 경우 앱 내 공지사항을 통해 고지합니다."
                )

                DisclosureSectionCard(
                    title: "시행일",
                    content: "- 본 개인정보 처리방침은 2025년 5월 26일부터 시행됩니다."
                )
            }
            .padding(Spacing.m)
        }
