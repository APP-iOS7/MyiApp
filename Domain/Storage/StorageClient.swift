...
public struct StorageClient: Sendable {
    ...
    public var uploadBabyProfilePhoto: @Sendable (UUID, Data) async throws(StorageError) -> URL
    ...
    public init(
        ...
        uploadBabyProfilePhoto: @escaping @Sendable (UUID, Data) async throws(StorageError) -> URL,
        ...
        self.uploadBabyProfilePhoto = uploadBabyProfilePhoto
