...
public struct NoteClient: Sendable {
    ...
    public var streamFutureScheduleNotes: @Sendable (UUID) -> AsyncStream<[Note]>
    ...
    public init(
        ...
        streamFutureScheduleNotes: @escaping @Sendable (UUID) -> AsyncStream<[Note]>,
        ...
        self.streamFutureScheduleNotes = streamFutureScheduleNotes
