...
struct DailySleepChartView: View {
    let weekDates: [Date]
    let records: [Record]
...
struct DailySleepListView: View {
    let records: [Record]
...
struct WeeklySleepListView: View {
...
struct MonthlySleepListView: View {
    ...
    var body: some View {
        ...
        DetailStatisticCardView(
            ...
            lastcount: recordsCount(for: .sleep, in: records, within: lastMonthRange),
            amount: nil,
            lastamount: nil,
            time: totalSleepMinutes(in: records, within: thisMonthRange),
            lasttime: totalSleepMinutes(in: records, within: lastMonthRange),
            mode : "monthly",
            selectedDate : selectedDate
        )
    }
