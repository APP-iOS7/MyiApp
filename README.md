...
- **홈 화면·타임라인 UI/UX**: 아기 정보 카드, 날짜 선택, 그리드, 15가지 기록 유형 타임라인 구현
- **Firebase·CaregiverManager 데이터 관리**: 사용자/아기 데이터 CRUD, 실시간 동기화, 다중 사용자·다중 아기 지원

상세 경험은 **STAR 형식**으로 [docs/star/](docs/star/)에 정리되어 있으며, 주요 아키텍처 결정은 [docs/adr/](docs/adr/)에서 ADR로 확인할 수 있습니다.
...
### 최범수 (상세 STAR: [docs/star/](docs/star/))
