...
### 장새벽
팀원들과의 코드 리뷰와 아키텍처 논의 과정에서 많은 것을 배웠습니다.
특히 다른 탭과의 데이터 일관성 유지와 공통 컴포넌트 설계를 통해 협업 개발의 노하우를 쌓을 수 있었습니다.
초기에는 각자의 구현 스타일이 달라 통일성 문제가 있었지만, 지속적인 소통을 통해 일관된 사용자 경험을 만들어낼 수 있었습니다.
